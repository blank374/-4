...
def main():
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "results_task3_optimized")
    ...
    if args.aggregate:
        ...
        return
    exe = (args.executable or root / ("task3_solver.exe" if os.name == "nt" else "task3_solver")).resolve()
    ...
    fingerprints = {"binary_sha256": sha256(exe), "solver_source_sha256": sha256(root / "task3_solver.cpp")}
