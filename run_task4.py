...
def main():
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "results_task4")
    ...
    exe = (args.executable or root / ("task4_solver.exe" if os.name == "nt" else "task4_solver")).resolve()
    ...
    software={"binary_sha256":sha256(exe),"source_sha256":sha256(root/"task4_solver.cpp"),"decision_source_sha256":sha256(root/"task4_common.py")}
